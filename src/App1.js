...
export default class App extends React.Component {
    ...
    constructor(props) {
        ...
        this.schema.properties.district.enumNames = ["namdong1", "phuloc1", "phongdien1"];
    }
    ...
    handleChange({ formData }) {
        ...
        for (const pro of arPro) {
            if (pro === "province") {
                this.schema.title = Date.now();
                console.log(this.schema.title);
                console.log(formData[pro]);
                console.log(this.objAddress[formData[pro]]);
                this.schema.properties.district = {
                    type: "string",
                    title: "Huyện",
